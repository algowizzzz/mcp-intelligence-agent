...
- **121+ Pre-built Tools** - Financial data, search, government APIs, enterprise connectors, analytics
...
│   ├── tools/                  # Tool JSON configurations (121 files)
...
The server includes 121+ pre-built tools organized by category:
