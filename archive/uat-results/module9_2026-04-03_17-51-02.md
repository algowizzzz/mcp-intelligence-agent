...
**Run ID:** `module9_2026-04-03_17-51-02`  
**Generated:** 2026-04-03 22:51:16 UTC  
...
| PA-07b | Uploaded file _uat9a_test_5c7edc.csv appears in domain_ | ✓ PASS |  |  |
...
| ID | Scenario | Status | Detail | ms |
|----|----------|--------|--------|----|
| PD-01 | OSFI list returns documents from MR worker domain_data | ✓ PASS |  | 1710 |
| PD-02 | DuckDB query returns tables from MR worker (customers/o | ✓ PASS |  | 2700 |
| PD-03 | IRIS CCR dates returned (2026-02-27, 2026-03-26, 2026-0 | ✓ PASS |  | 2912 |
| PD-04 | workflow_list called and returns ≥3 known MR workflow n | ✗ FAIL | wf_tool_called=True titles_found=[] | 2178 |
| PD-05 | md_save writes to w-market-risk/my_data/risk_agent/ | ✓ PASS |  | 2899 |
...
### [PD-04] workflow_list called and returns ≥3 known MR workflow names (text + tool output)
- **Status:** FAIL
- **Detail:** `wf_tool_called=True titles_found=[]`
- **Timestamp:** 2026-04-03T22:51:13.826716Z
