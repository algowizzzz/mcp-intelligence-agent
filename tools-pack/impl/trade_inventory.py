"""
Trade Inventory Tool — compliant with upstream SAJHA.

Ported from sajhamcpserver/sajha/tools/impl/trade_inventory_tool.py.
...
class TradeInventoryTool(BaseMCPTool):
    ...
    def execute(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {'trades': [], '_source': '', 'error': str(exc)}
        ...
        return {'trades': data, '_source': source}
