...
## Language selection
  ...
  * [Françaisfr](/fr/surveillance/pratiques-surveillance/cadre-surveillance-0)
...
## You are here
  ...
  1. [Home](/en "Home")
  2. [Supervision](/en/supervision "Supervision")
  3. [Supervisory practices](/en/supervision/supervisory-practices "Supervisory practices")
...
## On this page
  ...
  * Supervisory ratings for pension
...
### Our supervisory process
  ...
  * the work we do to identify risks at financial  institutions
  * how we assess financial institution’s  risks and assign ratings
  * our response to financial institution's  risks and the monitoring of remediation activity
  * how we report the results of our supervisory work  to financial institutions
...
The Overall Risk Rating (ORR) reflects the level of risk to the viability of a financial institution and has a 1 to 8 scale (ORR scale for financial institutions).
...
We share letters and other supervisory information with certain provincial regulators where agreements are in place. Information sharing also takes place when we host or attend supervisory colleges.
...
For example, the [Financial Institutions Supervisory Committee](/en/about-osfi/osfi-story/financial-institutions-supervisory-committee "Financial Institutions Supervisory Committee") is a committee whose members include OSFI, the Department of Finance, the Bank of Canada, the Canada Deposit Insurance Corporation, and the Financial Consumer Agency of Canada. It meets at least quarterly to share information on matters relating to supervising federally regulated financial institutions.

We also work with the Financial Transactions and Reports Analysis Centre of Canada (FINTRAC), which is responsible for ensuring compliance with Canada’s [Proceeds of Crime (Money Laundering) and Terrorist Financing Act](https://lois-laws.justice.gc.ca/eng/acts/P-24.501/).
...
Table 1: Definition of Tier Rating Tier | Definition
---|---
...
For institutions that receive individual rating categories, the category with the weakest rating becomes the starting point for the ORR.
...
Our assessment of financial resilience reflects the institution’s ability to withstand financial stress. It considers its financial risk profile, capital, liquidity, as well as the institutions exposure to catastrophic risk.
...
Table 2: Key guidelines for deposit taking institutions concerning financial resilience OSFI guideline | Area of relevance
---|---
...
Table 3: Key guidelines for insurers concerning financial resilience OSFI guideline | Area of relevance
---|---
...
Table 4: Key guidelines applicable for both deposit-taking institutions and insurers concerning financial resilience OSFI guideline | Area of relevance
---|---
...
Table 5: Key guidelines concerning operational resilience OSFI guideline | Area of relevance
---|---
...
Table 6: Key guidelines concerning risk governance OSFI guideline | Area of relevance
---|---
...
Table 7: ORR scale for institutions ORR | Description | Stage
---|---|---
1 | Minimal | 0
2 | Low | 0
3 | Moderate | 0
...
You can read more here about the foundations of our supervisory approach and our key principles of supervision.

### Our supervisory process

In the following sections we describe the main elements in our supervisory process:

  * the work we do to identify risks affecting pension plans
  * how we assess  pension plan’s  risks and assign ratings
  * our response to  pension plan’s  risks and the monitoring of remediation activity
  * how we report the results of our supervisory work  to pension plan administrators
...
Table 8: Definition of Tier Rating Tier | Definition
---|---
1 High | Large and/or complex institutions or pension plans with highest system impact
2 Medium-High | Large and/or complex institutions or pension plans with significant system impact
3 Medium | Mid-size institutions with moderate system impact | Large and/or complex pension plans
...
Table 9: ORR scale for pension plans ORR | Description | Stage
---|---|---
1 | Minimal | 0
2 | Low | 0
3 | Moderate | 0
