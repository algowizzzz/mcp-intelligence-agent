...
II. Concentration of funding ............................................................................................. 42
...
Introduction
1.  This document presents one of the Basel Committee’s 1 key reforms to develop a
...
2 The Sound Principles provide detailed guidance on the
...
over a longer time horizon by creating additional incentives for banks to fund thei r activities
...
horizon of one year. It has been developed to provide a sustainable maturit y structure of
...
elements of national discretion to reflect jurisdi ction-specific conditions. In these cases, the
...
liquidity profile, the Committee has also developed a set of monit oring tools to further
...
publication of the liquidity standards,
3 are designed to ensure that the LCR can be introduced
...
that, absent a situation of financial stress, t he value of the ratio be no lower than 100%
4 (ie
...
conditions, but also consider forward- looking assessments of macroeconomic and f inancial
...
(c) Supervisors should assess a numbe r of firm - and market -specific factors in
...
market-wide shock;
(iii) A bank’s overall health and risk profi le, including activities, positions with
...
funding,
5 or other actions by prudential authorities.
...
exposure to liquidity risk, strengthen its overall liquidity risk management, o r
...
(c) a partial loss of secured, short- term f inancing with certain collateral and
counterparties;
...
should hold beyond this minimum, and construct their own scenarios tha t could cause
...
These factors should assist supervisors in determining which assets, despite meetin g the
...
liquidity. Low duration,
7  low legal risk, low inflation risk and denomination in a
...
could be demonstrated by l ow bid-ask spreads, high trading volumes, and a
...
− There should be robust m arket infrastructure in place. The presence of
multiple co mmitted ma rket m akers increases l iquidity as quotes will most
...
to meet liquidity requirements. Volatility of traded prices a nd spreads are simple
proxy measures of market volatility. There should be historical evidence of relative
stability of market terms ( eg prices  and haircuts ) and volum es during stressed
periods.
...
discount or haircut to compensate for high market risk. That may not only erode t he market’s
...
banks
8 for intraday liquidity needs and overnight liquidity facilit ies. In the past, central banks
...
t
he basis for the categorisation of an asset as HQLA.
...
legal, regulatory, contractual or other restrictions on the ability of the bank to liquida te, sell,
...
(PSE) but have not been used to generate liquidity may be included in the stock.
9
32.  A b ank should exclude from  the stock those assets that, although meeting the
...
9  If a bank has deposited, pre-positioned or pledged Level 1, Level 2 and other assets in a collat eral pool and
...
period, would remove a hedge that would create an open risk position in excess of i nternal
limits.
...
the contractual right to withdraw those assets during the 30-day stress period.
10
...
46. There are two categories of assets that can be included in the stock. Assets t o be
...
(Level 2B assets - see paragraph 53 below). If included, t hese assets should comprise no
...
• not an obligation of a financial institution or any of its affiliated entities.
18
(b) Corporate debt securities (including commercial paper) 19 and covered bonds 20 that
...
20  Covered bonds are bonds issued and owned by a bank or mortgage institution a nd are subject by law to
...
22 Supervisors are also expected to ensure that banks have appropriate
...
(a) Residential mortgage backed securities (RMBS) that sati sfy all of the following
...
Basel II’s s tandardised approach for credit risk. Local rating scales (rather than international ratings) of a
supervisor-approved ECAI that meet the eligibility criteria outlined in paragraph 91 of the Basel II Capital
Framework can be  recognised if corporate debt se curities or covered bonds are held by a bank for local
...
and Level 2 assets
24) in their domestic currency to meet the aggregate demand of banks with
...
is a true shortfall in HQLA in the domestic currency relative to the needs in that currency.
25
56. To qualify for the alter native treatment, a jurisdiction should be able to demonstrate
that:
...
25  For member states of a monet ary union with a common currency, that common currency is considered the
“domestic currency”.
...
differences in credit risk. A jurisdiction seeking to adopt Option 1 should justif y in the
...
currencies that do not have sufficient HQLA, as determined by re ference to the qualifying
...
markets.
27 For other currencies, jurisdictions should increase the haircut to an appropriate
level on the basis of historical (monthly) exchange rate volatilities between the currency pair
over an extended period of time.
28 If the domestic currency is formally pegged to another
...
review the effectiveness of its currency peg mechanism and ass ess the long- term prospect
of keeping the peg.
...
27  T hese refer to currencies that exhibit significant and active market turnover in the global foreign currency
...
considerations.
30 Supervisors have the obligation to conduct an analysis to assess whether
...
currency concerned.
31 HQLA associated with the options refer to: (i) in the case of Option 1,
...
to include HQLA associated with the options (after applying any relevant hairc ut) up to 80%
of the required amount of HQLA in the relevant currency.
32 Thus, at least 20% of the HQLA
...
which is still within the 8 0% level. The total amount of alternative HQLA used is 25% (ie 10% + 15%
...
characteristics o f an alternative HQLA portfolio must be considered to be more
...
69. The term total net cash outflows 33 is defined as the total expected cash outflows
...
jurisdiction.
33  Where applicable, cash inflows and outflows should include interest that  is expected to be receiv ed and paid
...
deposits that are fully insured 34 by an effective deposit insurance scheme or by a public
...
34  “Fully insur ed” means that 100% of the deposit amount, up to the deposit insurance limit, is covered by an
...
80. If a bank is not able to readily identify which retail deposits would qualif y as “stable”
...
clearly state the treatment that applies for their jurisdiction and apply this trea tment in a
...
account reputational factors that may limit a bank's ability not to exercise the option.
39 In
...
87. Wholesale funding that is callable
40 by the funds provider subject to a contractually
...
detailed below, based on the assumed sensitivi ty of the funds providers to the rate offered
...
risk characteristics to retail accounts provided the total aggregated funding 41 raised from one
...
95.  Q ualifying operational deposits generated by such an activity are ones where:
...
domestic currency of the respondent bank for t he provision of clearing and settlement of payments ). Prime
...
legally autonomous banks with a statutory framework of cooperation with common strat egic
...
conduits and special purpose vehicles, affiliated entities of the bank 45 and other entities that
...
43  Fiduciary is d efined in this context as a legal entity that is  authorised to manage assets on behalf of a third
...
48 Options should be assumed to be exercised when they are ‘ in
...
bank’s short-term rating should be assumed to be triggered at the corresponding l ong-term
...
valuation changes. If however, counterparties are securi ng mark-to-market exposures with
...
collateral.
 This 20% will be calculated based on the notional amount required to be posted as
...
122. I ncreased liquidity needs related to contracts that allow collateral substitution
to non -HQLA assets: 100% of the amount of HQLA coll ateral that can be substituted for
...
under the same master netting agreement can be treated on a net basis. Any o utflow
generated by increased needs related to market valuation changes should be included in the
LCR calculated by identifying the largest absolute net 30- day collateral flow realised dur ing
...
124.  Loss of funding on asset -backed securities,
49  covered bonds and other
...
structured financing activities of a bank are conducted through a special purpose entity
50
...
50 A s pecial purpose entity (SPE) is defined in the Ba sel II Framework (paragraph 552) as a corporation, trust, or
...
short-term f acilities frequently renewing or automatically rolling -over. In a stressed
environment, it will likely be difficult for customers drawing on facilities of any maturity, even
short-term maturities, to be able to quickly pay back the borrowings. Therefore, f or purposes
...
facility (ie the remaining commitment) would be treated as a comm itted credit facility with its
...
131. A ny contractual loan draw downs from committed facilities 51  and estimated
...
these facilities.
(e) Committed credit facilities to other financial institutions  including securi ties firms,
...
(f) C ommitted liquidity facilities to other financial institutions including securities firms,
insurance companies, fiduciaries, and beneficiaries : Banks should assume a 100%
drawdown of the undrawn portion of these liquidity facilities.
(g) C ommitted credit and liquidity facilities to other legal entities  (including SPEs (as
...
54  The potential liquidity risks associated with the bank's own structured financing facilities should be tr eated
...
and are not lending commitments. Non- contractual cont ingent funding obligations include
...
whether and to what extent these contingent outflows are to be included in the LC R. All
...
137.  Non contractual contingent funding obligations related to p otential liquidity draws
...
138. In the case of contingent funding obligations stemming from trad e finance
...
140. National authorities should determine the run -off r ates for the other contingent
funding obligations listed below in accordance with paragraph 1 34. Other contingent funding
...
inflows (0%). Maturing reverse repurchase or securities l ending agreements secured by
...
section.
146.  A s an exception to  paragraph 145, if the collateral obtained through reverse repo,
...
153. This scenario assumes that banks will receive all payment s (including interest
...
outlined in paragraphs 105  and 106; in other words, the depositing bank should not coun t
...
considered significant, taking into ac count the liquidity impact of such investments on the
...
57 A banking group should have processes in place
...
1. C ontractual cashflow assumptions
...
58 (such as for overnight commercial paper / certificate of deposit
(CP/CD) funding).
...
59 The actual concentration of
...
funding dated longer than overnight, etc), it is not always possible to identify the counterparty holding the debt.
60  Eg where the monitored institution also extends funding or has large unused credit lines outstanding t o the
...
C. Utilisation of the metric
208. These metrics are useful for exam ining the potential for a bank to generate an
additional source of HQLA or secured funding. They will provide a s tandardised measure of
...
potential currency mi smatches, banks and supervisors should also monitor the LCR in
...
cap is binding, up to a maximum of 1/4 of the adjusted amount of Level 1 as sets, both after
...
date up to and including 30 calendar days. R elevant haircuts  would be applied prior to
...
All of t he Principles have to be satisfied in order to qualify for alternative treatment.
...
HQLA cannot be simply reflected by the numbers provided, it should pr ovide further
...
banks in domestic currency. The jurisdicti on should then explain the method of deriving the
...
demand and justifications for such adjustments .
66 The jurisdiction should demonstrate that
...
the constraints, the jurisdiction should support the analysis with appropriate quantitativ e
information.
...
out of the past ten years or at least two out of the past three years)
67 can be an
...
(including those that may not have the insufficiency issue). While this ratio alone ca nnot give
...
facility, covering:
(i) the commitment fee (including the basis on which it is charged,
70 the method of
...
to maturity,
72 and whether there will be restrictions on a bank’s ability to draw down
on the facility);73
...
types of HQLA denominated in those currencies
74) allowable under this option,
...
76 the justifications should be clearly stated to
...
haircuts as prescribed under this framework (ie at least 8% for major currencies
77).
...
assets (used under Option 3) and Level 1 assets in the domestic currency ar e generally of
...
the option to be used as well as jurisdiction- specific considerati ons. The scope of these
...
jurisdiction should determine the reporting requirements, including the types o f data and
...
alternative treatment, and m ake that explicit and transparent to other national
...
options for al ternative treatment. The document should contain clear and transparent
...
committed liquidity facility, including the maturity of the facility, the commitment f ee
...
(and types of securi ties under those currencies) allowed to be used, haircuts
applicable to the foreign currency HQLA, and any restrictions on banks’ usage of
this option;
(v) Option 3- related information : if Option 3 will b e adopted, the Level 2A assets
...
36. The jurisdiction shoul d update the disclosed information whenever there are
...
from the self -assessment, the juris diction should disclose its plan to address those
...
any member jurisdiction of the Committee that intends to adopt the options for alternati ve
...
1 assets in the market. A bank m ust then ensure that it is able to hold and maintain Level 1
